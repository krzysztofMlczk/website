...
router.get("/projects/smart-mirror", (req, res) => {
...
router.get("/projects/spachet", (req, res) => {
...
router.get("/projects/minigolf", (req, res) => {
...
router.get("/projects/go-game", (req, res) => {
...
router.get("/projects/compiler", (req, res) => {
...
router.get("/projects/car-dealership-system", (req, res) => {
